        ...
        cr.execute("""
            ...
            FROM
                ...
                SELECT  mi.partner_id,
                        mi.name,
                        mi.date,
                        sd.amount + sd.benefit_amount AS sale_amount,
                        sd.benefit_amount AS benefit_amount,
                ...
                JOIN wh_move AS whm ON mi.move_id = whm.id
                JOIN sell_delivery AS sd ON sd.sell_move_id = whm.id
                WHERE c.type = 'income'
                ) AS ps)
        """)
